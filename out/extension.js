...
function activate(context) {
    ...
    const chatPanel = new webviewProvider_1.ChatPanel(context);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider(webviewProvider_1.ChatPanel.viewType, chatPanel));
